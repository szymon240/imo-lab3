...
def run_test_lab1(algorithm_name: str, distance_matrix: np.ndarray, positions: np.ndarray, algorithm: Callable[[np.ndarray], tuple[list[int], list[int]]]):
    avg_cost, min_cost, max_cost, avg_time, min_time, max_time, best_cycle1, best_cycle2 = experiment_lab1(distance_matrix, algorithm)
    print(f"\n{algorithm_name}:")
...
def run_test_lab2(
    ...
    avg_length, min_length, max_length, avg_time, min_time, max_time, best_solution = experiment_lab2(matrix, cycle1, cycle2, alg, min_time_alg)
